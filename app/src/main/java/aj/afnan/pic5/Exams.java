...
private ExpandableListView simpleExpandableListView;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        listAdapter = new CustomAdapter(Exams.this , deptList);
            ...
            public boolean onChildClick(ExpandableListView parent, View v, int groupPosition, int childPosition, long id) {
                ...
                if (groupPosition == 0) {
                    ...
                    ForMore.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            String name = "http://www.tvtc.gov.sa/Arabic/Departments/Departments/pt/Exams/Medtermexam%20Exam/Pages/default.aspx";
                ...
                if (groupPosition == 1) {
                    ...
                    ForMore.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            Intent intent = new Intent(getApplicationContext(), WebViewActivity.class);
                            String name = "http://www.tvtc.gov.sa/Arabic/Departments/Departments/pt/Exams/Comprehensive%20exam/Pages/default.aspx";
                            Bundle bundle = new Bundle();
                            bundle.putString("name", name);
                            intent.putExtras(bundle);
                            startActivity(intent);
    ...
    private void loadData(){
        ...
        addProduct("الاختبار التأهيلي","هو اختبار تعقده المؤسسة العامة للتدريب التقني والمهني للمتدربين الذين أنهوا متطلبات الدورة التأهيلية بنجاح لكافة منشآت التدريب الأهلية المرخص لها بمزاولة النشاط التدريبي في مجال الدورات التأهيلية.","للمزيد" );
        addProduct( "الاختبار الشامل", "هو اختبار تعقده المؤسسة العامة للتدريب التقني والمهني للمتدربين الذين أنهوا متطلبات البرنامج التدريبي أو الدبلوم بنجاح لكافة منشآت التدريب الأهلية المرخص لها بمزاولة النشاط التدريبي في مجال البرامج التدريبية والدبلوم.", "للمزيد");
    }
